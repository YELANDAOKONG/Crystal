...
/// <summary>
/// Represents one ordered event for an explicit Harness invocation.
/// </summary>
public abstract record HarnessEvent
{
    private protected HarnessEvent(
        Guid sessionId,
        Guid invocationId,
        AgentName agentName,
    ...
    /// <summary>
    /// Gets the zero-based event sequence within this invocation.
    /// </summary>
