...
/// <summary>Records the exact candidate selected by caller policy.</summary>
public sealed record MultimodalAgentCandidateSelectedEvent
    : MultimodalAgentRunEvent
{
    /// <summary>Initializes a multimodal candidate-selection event.</summary>
    ...
    public MultimodalAgentCandidateSelectedEvent(
        Guid runId,
        long sequence,
        int modelCallNumber,
        int candidateIndex,
        MultimodalChatCandidate candidate)
        : base(runId, sequence)
    {
    ...
    /// <summary>Gets the zero-based selected candidate index.</summary>
    public int CandidateIndex { get; }

    /// <summary>Gets the exact selected candidate.</summary>
    public MultimodalChatCandidate Candidate { get; }
}
