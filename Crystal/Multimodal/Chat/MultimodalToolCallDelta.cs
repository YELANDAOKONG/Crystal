...
/// <summary>Carries exact deltas for one streamed multimodal tool call.</summary>
public sealed record MultimodalToolCallDelta : MultimodalChatItemStreamEvent
{
    /// <summary>Initializes a streamed multimodal tool-call delta.</summary>
    ...
    public MultimodalToolCallDelta(
        int candidateIndex,
        int itemIndex,
        string callIdDelta,
        string nameDelta,
    ...
    /// <summary>Gets the exact call-identifier delta.</summary>
    public string CallIdDelta { get; }

    /// <summary>Gets the exact tool-name delta.</summary>
    public string NameDelta { get; }

    /// <summary>Gets the exact raw-arguments delta.</summary>
