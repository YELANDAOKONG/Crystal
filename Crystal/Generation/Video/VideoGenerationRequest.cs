...
/// <summary>
/// Contains one immediate video-generation request, including optional audio
/// reference inputs.
/// </summary>
public sealed record VideoGenerationRequest
{
    /// <summary>Initializes an immediate video-generation request.</summary>
    /// <param name="inputs">
    /// The ordered typed inputs. Audio reference and source inputs are
    /// preserved without being converted into video metadata.
    /// </param>
    ...
    public VideoGenerationRequest(
        ...
        VideoGenerationRequirements? requirements = null,
    ...
    public VideoGenerationRequirements? Requirements { get; }
    ...
    /// <inheritdoc />
    public override string ToString() => nameof(VideoGenerationRequest);
}
